...
def generate_launch_description():
    ...
    default_params_file = os.path.join(get_package_share_directory("nera_bot"),
    ...
    start_async_slam_toolbox_node = IncludeLaunchDescription(
            ...
            )]), launch_arguments={'slam_params_file': actual_params_file, 'use_sim_time': use_sim_time}.items()
    )
